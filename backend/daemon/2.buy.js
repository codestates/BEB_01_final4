...
//사용자2(account7)
const ownerAddress = '0xcdD1082F673Ef6B220792Df66E84793147bE4Dd0';
const privateKey = 'b4c9e480b3bb235376e0fd29ea701e7d35dd96a5ce31b0ae32f635b4d8b21e6d';

//NFT 의 컬랙션 정보
//wemix1 const ca = '0xDe8af62c2fB6efCfBB44Df1deF74861d7b32c2B5';
//wemix2 
const ca = '0x852aF41AF97c7cC508392bD08166aE10ED321280';

//trade CA
//const trade_ca = '0xe894CeEe42AC21Db94126F9d0551c4ba0c5026E2';
...
/*
{
  name: 'payment',
  params: [
    { name: 'option', value: '1', type: 'uint256' },
    { name: 'tokenId', value: '2', type: 'uint256' }
  ]
}
*/
...
const buy = async (MyOption, MyToken_ids, MyPrice) => {
  //보낼 트랜잭션 데이터 생성
  const data = contractObj.methods.payment(MyOption, MyToken_ids).encodeABI();
  ...
  const tx = {
    ...
    gas: 2000000,
    data: data,
    value: web3.utils.toWei(String(MyPrice), "ether")
  };
...
checkDecode('0x0038171277171481ac90b6ed555671a1b570668e5a4984b4257e92ef0252ad49');
